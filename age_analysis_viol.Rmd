...
```{r}
ggsave("Figures/age_spline_viol.pdf",plot = age_spline_viol, width = 5, height = 4, units = "in")
...
ggsave("Figures/lb_inds_freq_viol.pdf",plot = lb_inds_freq_viol, width = 5, height = 4, units = "in")
