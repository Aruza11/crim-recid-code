...
features = features %>%
  ...
  mutate(
    ...
    filt6 = vio_hist == 0 & history_noncomp==0 # Filter 6
  )
```
...
age_spline_viol = 
  ...
  scale_color_manual(values=c("red","darkorchid1", "grey25")) + 
...
```{r}
# ggsave("Figures/fireplot_lb_viol.pdf",plot = fireplot_lb_viol, width = 7, height = 4, units = "in")
ggsave("Figures/fireplot_all_viol.pdf",plot = fireplot_all_viol, width = 7, height = 4, units = "in")
# ggsave("Figures/age_first_offense_viol.pdf",plot = age_first_offense_viol, width = 7, height = 4, units = "in")
...
ggplot(features%>%filter(filt1,filt5,filt7), 
       aes(x=vio_hist)) +
     geom_histogram()  +
     ggtitle("Distribution of Summed History of Violence Subscale Items\nfor All Individuals")
