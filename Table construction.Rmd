...
features=distinct(df_beforeCOMPAS, person_id, first,last,age,sex,marital_status,race,compas_person_id,compas_case_id,compas_assessment_id,screening_date,agency_text,custody_status)%>%
...
nrow(filter(features, cq_violent_conviction==1,cq_prior_conviction_F==0,cq_prior_conviction_M==0))
```
