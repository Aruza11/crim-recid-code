...
NOTE: DFNEW ONLY CONTAINS INFORMATION FROM BEFORE THE COMPAS EVALUATION (so we can perform predictive analysis on the code)
...
Question: isn't the prior conviction (M/F) feature derived from the above two? How is it different?
```{r}
