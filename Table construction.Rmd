...
features=as_data_frame(distinct(dfnew, person_id, first,last,age,sex,marital_status,race))
...
I will take "screening date" as current, and any offenses which occurred up to 5 days before this screening date as current offenses. 
...
#Not really sure what I did this for?
...
To do: proofread all of code, compute whether or not they recidivated (y_recidivated). Drugs, traffic crimes, broward-sheriff-data, add compas score, check latest screenig date
