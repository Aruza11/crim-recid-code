...
```{r}
features<-features%>%
            left_join(dynamic_fel,by=person_id)%>%
            left_join(dynamic_incarceration,by=person_id)%>%
            left_join(dynamic_misdem,by=person_id)%>%
            left_join(dynamic_misdem,by=person_id)%>%
            left_join(arnold1,by=person_id)%>%
            left_join(arnold2,by=person_id)%>%
            left_join(arnold3,by=person_id)
