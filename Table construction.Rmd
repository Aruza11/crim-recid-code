...
kurt=filter(df_beforeCOMPAS,person_id==7294)
kurt700=filter(kurt,gap==-700)
unique(kurt$offense_date>kurt$screening_date)
kurtCOMPAS_offense_date=unique(kurt$COMPAS_offense_date)
max(kurt$offense_date)==kurtCOMPAS_offense_date
unique(kurt$offense_date)
unique(kurt$screening_date)
