...
Writing individuals' compas score to file. I am doing this separately because I want the features table to be 1 row per person, which it cannot be if I add the compas scores (b/c each person has 3 scores for compas). *Note: some people have more than 1 set of COMPAS scores.*
...
arnold1<-df_beforeCOMPAS%>%
            ...
            mutate(screening_date=ymd_hms(screening_date), 
                  ...
                  current_age=round(as.numeric((screening_date-dob)/365.25)),
