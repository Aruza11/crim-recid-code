...
# 
# inds2 = charge2 %>%
#        filter(person_id %in% c(3073,
#                                 3978,
#                                 8573))
# inds1 = charge2 %>%
#        filter(person_id %in% c(621,
#                                 3730,
#                                 6574))  %>%
#        filter(screening_date != "2013-08-27")
# 
# inds3 = charge2 %>%
#        filter(person_id %in% c(89,
#                                 8652,
#                                 8573))
#   
# View(inds1 %>% filter(person_id == 6574))
# 
# write.csv(inds1,"inds1_offenses.csv")
# write.csv(inds2,"inds2_offenses.csv")
# write.csv(inds3,"inds3_offenses.csv")
