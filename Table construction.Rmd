...
df_screendate identifies the COMPAS offense date by taking the offense which occurred closest to the compas screening date. people who have two screening dates have two COMPAS offenses. 
...
# compas_flat=compas_scores%>%
#             # group_by(person_id,screening_date)%>%
#                 select(person_id,screening_date,raw_score, type_of_assessment)%>%
#                 dcast(person_id+screening_date~type_of_assessment, value.var="raw_score")    
