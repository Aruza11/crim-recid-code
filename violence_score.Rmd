...
bottom_age1=features%>%
           group_by(p_age_first_offense)%>%
              arrange(p_violence_raw-age_poly(p_current_age),.by_group=TRUE)%>%
              top_n(n=-1,wt=p_violence_raw)

ggplot(bottom_age1, aes(x=p_age_first_offense, y=p_violence_raw-age_poly(p_current_age))) +
     geom_point(shape=1)  
...
ggplot(age_subset, aes(x=p_current_age, y=p_violence_raw)) +
     geom_point(shape=1)  +
     ggtitle("Risk of Violence Raw vs Age at Current Offense, age_subset")

ggplot(age_subset, aes(x=p_age_first_offense, y=p_violence_raw)) +
     geom_point(shape=1)  +
     ggtitle("Risk of Violence Raw vs Age at First Offense, age_subset")

```
Examing people in age_subset more closely
```{r}
#looking at people in age_subset (bottom edge of age vs raw violence score relationship) and plotting against age_first_offense instead
...
ggplot(age_subset, aes(x=p_yrs5_felcount_person, y=p_violence_raw)) +
     geom_point(shape=1)  +
     ggtitle("Risk of Violence Raw vs 5YrFelcount, age_subset")

ggplot(age_subset, aes(x=p_misdem_count_5yrs, y=p_violence_raw)) +
     geom_point(shape=1)  +
     ggtitle("Risk of Violence Raw vs 5YrMisdem, age_subset")

ggplot(age_subset, aes(x=cq_fail_appear_two_yr+cq_fail_appear_two_plus, y=p_violence_raw)) +
     geom_point(shape=1)  +
...
ggplot(bottom_age2, aes(x=p_age_first_offense, y=p_violence_raw)) +
     geom_point(shape=1)  +
...
ggplot(bottom_age2, aes(x=p_age_first_offense, y=p_violence_raw)) +
     geom_point(shape=1)  +
     geom_point(data=age_subset, aes(x=p_age_first_offense, y=p_violence_raw),shape=1, color="red") +
     ggtitle("Risk of Violence Raw vs Age at First Offense, bottom_age2 and age_subset")

ggplot(bottom_age2, aes(x=p_current_age, y=p_violence_raw)) +
     geom_point(shape=1)  +
...
ggplot(bottom_age2, aes(x=p_current_age, y=p_violence_raw)) +
     geom_point(shape=1)  +
     geom_point(data=age_subset, aes(x=p_current_age, y=p_violence_raw),shape=1, color="red") +
     ggtitle("Risk of Violence Raw vs Age at Current Offense, bottom_age2 and age_subset")


ggplot(bottom_age2, aes(x=p_yrs5_felcount_person, y=p_violence_raw)) +
     geom_point(shape=1)  +
     ggtitle("Risk of Violence Raw vs 5YrFelcount, bottom_age2")

ggplot(bottom_age2, aes(x=p_misdem_count_5yrs, y=p_violence_raw)) +
     geom_point(shape=1)  +
     ggtitle("Risk of Violence Raw vs 5YrMisdem, bottom_age2")

ggplot(bottom_age2, aes(x=cq_fail_appear_two_yr+cq_fail_appear_two_plus, y=p_violence_raw)) +
     geom_point(shape=1)  +
...
ggplot(offense1, aes(x=p_current_age, y=p_violence_raw)) +
     geom_point(shape=1)  +
     geom_point(data=age_subset, aes(x=p_current_age, y=p_violence_raw),shape=1, color="red") +
...
for(age in (18:60)){
  ...
  print(
    ggplot(filter(offense1, p_current_age==age) , aes(x=p_age_first_offense, y=p_violence_raw)) +
     geom_point(shape=1)  +
...
ggplot(offense2, aes(x=p_current_age, y=p_violence_raw)) +
     geom_point(shape=1)  +
     geom_point(data=age_subset, aes(x=p_current_age, y=p_violence_raw),shape=1, color="red") +
     ggtitle("Risk of Violence Raw vs Age at Current Offense, offense1")

ggplot(offense2, aes(x=p_age_first_offense, y=p_violence_raw)) +
     geom_point(shape=1)  +
     ggtitle("Risk of Violence Raw vs Age at First Offense, offense1")

for(age in (18:60)){
  print(
    ggplot(filter(offense2, p_current_age==age) , aes(x=p_age_first_offense, y=p_violence_raw)) +
     geom_point(shape=1)  +
     ggtitle(paste0("age=",age, ", offense1"))
  )
...
ggplot(features, aes(x=p_felassault_arrest, y=p_violence_raw-age_poly(p_current_age)))+
  geom_point(shape=1)+
  xlim(0,5)+ ylim(-1.5,3)+
